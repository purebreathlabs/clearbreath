...
## Global rules
- Never write code comments. No single-line, no multi-line, no doc comments. Zero tolerance.
...
- Always Read full `docs/final_plan.md` for product requirements and architecture decisions.
